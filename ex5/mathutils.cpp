...
long vector_average(std::vector<int>& vec){
    int sum = 0;
    long average;
...
void print_primes(std::vector<int>& vec){ //used more GPT than usual, we've done this exact exercise too many times by this point.
...
void print_perfect_numbers(std::vector<int>& vec){
